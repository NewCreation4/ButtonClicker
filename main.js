...
const Update={
  points: () => {
    document.getElementById("points").innerHTML=`<img src="./sprites/currencies/point.png">Points: ${GET("points")}P`
  },
  clickanium: ()=>{
    document.getElementById("clickanium").innerHTML=`<img src="./sprites/currencies/clickanium.png">Clickanium: ${GET("clickanium")}C`
  }
}
Update.points()
Update.clickanium()
